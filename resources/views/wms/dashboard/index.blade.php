            ...
            <div class="card-body card-content">
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        ...
                        <p class="card-label">Internet pengguna</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card-body card-content">
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        ...
                        <span class="fw-bold fs-6">Rp 250.000</span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="card gradient-card pt-1 pb-2">
            <div class="card-body card-content">
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        <h2 class="card-number text-white" id="estimatedMonthlyIncome">
                            <div class="spinner-border spinner-border-sm" role="status">
                                <span class="visually-hidden">Loading...</span>
                            </div>
                        </h2>
        ...
        <div class="card gradient-card">
            <div class="card-body card-content">
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        <h2 class="card-number text-white" id="paidCurrentMonth">
                            <div class="spinner-border spinner-border-sm" role="status">
                                <span class="visually-hidden">Loading...</span>
                            </div>
                        </h2>
                        <p class="card-label">Pembayaran bulan ini</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="card gradient-card">
            <div class="card-body card-content">
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        <h2 class="card-number text-white" id="unpaidCurrentMonth">
                            <div class="spinner-border spinner-border-sm" role="status">
                                <span class="visually-hidden">Loading...</span>
                            </div>
                        </h2>
                        <p class="card-label">Yang belum bayar dibulan ini</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="card gradient-card">
            <div class="card-body card-content">
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        <h2 class="card-number text-white" id="countOverdueBilling">
                            <div class="spinner-border spinner-border-sm" role="status">
                                <span class="visually-hidden">Loading...</span>
                            </div>
                        </h2>
                        <p class="card-label">Total pangihan jatuh tempo</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="card-body">
            <ul class="p-0 m-0">
                ...
                <div id="dataTransaction" class="d-none">
                    ...
                    <img src="https://ui-avatars.com/api/?background=2563eb&name=Andi Saputra&color=fff" alt="User" class="rounded" />
                    </div>
                ...
                <li class="d-flex mb-4 pb-1">
                    <div class="avatar flex-shrink-0 me-3">
                    <img src="https://ui-avatars.com/api/?background=2563eb&name=Rina Marlina&color=fff" alt="User" class="rounded" />
                    </div>
                    <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                    <div class="me-2">
                        <small class="text-muted d-block mb-1">Transfer</small>
                ...
                <li class="d-flex mb-4 pb-1">
                    <div class="avatar flex-shrink-0 me-3">
                    <img src="https://ui-avatars.com/api/?background=2563eb&name=Budi Santoso&color=fff" alt="User" class="rounded" />
                    </div>
                    <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                    <div class="me-2">
                ...
                <li class="d-flex mb-4 pb-1">
                    <div class="avatar flex-shrink-0 me-3">
                    <img src="https://ui-avatars.com/api/?background=2563eb&name=Siti Rahmawati&color=fff" alt="User" class="rounded" />
                    </div>
                    <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                    <div class="me-2">
                        <small class="text-muted d-block mb-1">Transfer</small>
                ...
                <li class="d-flex mb-4 pb-1">
                    <div class="avatar flex-shrink-0 me-3">
                    <img src="https://ui-avatars.com/api/?background=2563eb&name=Dedi Kurniawan&color=fff" alt="User" class="rounded" />
                    </div>
                    <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                    <div class="me-2">
                        <small class="text-muted d-block mb-1">Transfer</small>
                ...
                <li class="d-flex mb-4 pb-1">
                    <div class="avatar flex-shrink-0 me-3">
                    <img src="https://ui-avatars.com/api/?background=2563eb&name=Lina Agustin&color=fff" alt="User" class="rounded" />
                    </div>
                    <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                    <div class="me-2">
                        <small class="text-muted d-block mb-1">Cash</small>

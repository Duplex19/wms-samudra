@extends('layouts.app')
@section('content')
    <button class="btn btn-primary mb-3" data-bs-toggle="modal" data-bs-target="#addVpnServer"><i class="bx bx-server"></i>
        Tambah akun VPN Server</button>
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="card-body">
                <div class="alert alert-primary" role="alert">
                    ...
                    <p><svg class="bi flex-shrink-0 me-2" width="24" height="24" role="img" aria-label="Info:">
                            <use xlink:href="#info-fill" />
                        </svg>Gunakan Akun VPN untuk Membuat L2TP Client ( Tanpa IpSec Secret ) Di Mikrotik Yang Ingin Di
                        Gunakan</p>
                </div>
